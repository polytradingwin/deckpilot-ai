...
function buildSystemPrompt() {
  return [
    ...
    "The first rendered node is the executive summary before the presenter starts explaining branches.",
...
function buildUserPrompt(input: MindMapRequest) {
  return [
    ...
    "- The summary.headline should be a compact conclusion suitable for the first screen.",
